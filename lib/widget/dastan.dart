...
class Dastan extends StatelessWidget {
  @override
        ...
        child: Column(children: <Widget>[
          ...
          Positioned(
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(image: AssetImage("Food/dastan.jpg"),fit: BoxFit.fitWidth),
              ),
            ),
          ),
          Row(
          ...
          Positioned(
            ...
            [
              ...
              CustomText(text:"25 min",),
              Icon(Icons.location_on,size: 25,),
              CustomText(text:"8 km",)
            ]
            ),
          ),
          SizedBox(height: 13),
